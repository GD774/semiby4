...
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 1, STANDARD_HASH('admin', 'SHA256'), 'admin@example.com', '관리자', 'man', '010-1111-1111', CURRENT_DATE, CURRENT_DATE);
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 0, STANDARD_HASH('1111', 'SHA256'), 'tester1@example.com', '테스터1', 'man', '010-1111-1111', CURRENT_DATE, CURRENT_DATE);
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 0, STANDARD_HASH('2222', 'SHA256'), 'tester2@example.com', '테스터2', 'man', '010-2222-2222', CURRENT_DATE, CURRENT_DATE);
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 0, STANDARD_HASH('3333', 'SHA256'), 'tester3@example.com', '테스터3', 'man', '010-3333-3333', CURRENT_DATE, CURRENT_DATE);
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 0, STANDARD_HASH('4444', 'SHA256'), 'tester4@example.com', '테스터4', 'man', '010-4444-4444', CURRENT_DATE, CURRENT_DATE);
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 0, STANDARD_HASH('5555', 'SHA256'), 'tester5@example.com', '테스터5', 'man', '010-5555-5555', CURRENT_DATE, CURRENT_DATE);
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 0, STANDARD_HASH('6666', 'SHA256'), 'tester6@example.com', '테스터6', 'man', '010-6666-6666', CURRENT_DATE, CURRENT_DATE);
COMMIT;
